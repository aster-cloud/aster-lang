...
- 指令：
  ...
  - `ASTER_COMPILER=java ./gradlew-java25 :aster-lang-cli:run --args 'parse cnl/examples/hello.aster --json'`
  - `ASTER_COMPILER=java ./gradlew-java25 :aster-lang-cli:run --args 'parse cnl/examples/int_match.aster --json'`
- 结果：
  - Java 编译器后端成功编译。
