...
import { DiagnosticSeverity, type Diagnostic } from '../../src/diagnostics.js';
...
class MockPackageRegistry extends PackageRegistry {
  ...
  async listVersions(packageName: string): Promise<string[] | import('../../src/diagnostics.js').Diagnostic[]> {
  ...
  async downloadPackage(packageName: string, version: string, targetPath: string): Promise<void | import('../../src/diagnostics.js').Diagnostic[]> {
