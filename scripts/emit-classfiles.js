...
function sh(cmd, opts = {}) { cp.execSync(cmd, { stdio: 'inherit', ...opts }); }
...
async function main() {
  ...
  await new Promise((resolve, reject) => {
    const proc = cp.spawn(runCmd, [':aster-asm-emitter:run', '--args=build/jvm-classes'], { stdio: ['pipe', 'inherit', 'inherit'] });
